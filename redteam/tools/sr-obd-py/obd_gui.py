...
# OBD variables
#BACKGROUND_FILENAME = "saferide.jpg"
#LOGO_FILENAME 		= "saferide_logo.png"

BACKGROUND_FILENAME = "saferide.png"
...
class OBDLoadingPanel(wx.Panel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        bitmap = wx.Bitmap(BACKGROUND_FILENAME)
        width, height = bitmap.GetSize()
        image = wx.ImageFromBitmap(bitmap)
        image = image.Scale(width/2, height/2.1, wx.IMAGE_QUALITY_HIGH)
        bitmap = wx.BitmapFromImage(image)
        control = wx.StaticBitmap(self, wx.ID_ANY, bitmap)
        #control.SetPosition((10, 10)) 
