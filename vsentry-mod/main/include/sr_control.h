...
struct config_params_t {
	...
	SR_U8	def_file_action;					/* default action for file classifier */
	SR_U8	def_can_action;						/* default action for canbus classifier */
	SR_U8	def_net_action;						/* default action for network classifier */
};
